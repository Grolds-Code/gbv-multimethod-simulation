# ==============================================================================
# GBV EPIDEMIOLOGICAL ANALYSIS - PHASE 3: CAUSAL INFERENCE (LOGISTIC REGRESSION)
# ==============================================================================
# Purpose: Estimate adjusted associations accounting for confounding
# Output: Odds ratios, model diagnostics, interaction tests
# ==============================================================================

cat("\n\n")
cat(" PHASE 3: CAUSAL INFERENCE (LOGISTIC REGRESSION) STARTING...\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")
...
# 3.3 PREPARE ANALYSIS DATASET
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat(" Step 2: Preparing analysis dataset...\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")

# Create centered age variable (for interpretation)
data_sim <- data_sim %>%
  mutate(
...
# 3.4 MODEL 1: INDIVIDUAL FACTORS ONLY
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat(" MODEL 1: Individual Factors Only\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")
...
# 3.5 MODEL 2: INDIVIDUAL + RELATIONSHIP FACTORS
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat(" MODEL 2: Individual + Relationship Factors\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")
...
# 3.6 MODEL 3: FULL ECOLOGICAL MODEL (INDIVIDUAL + RELATIONSHIP + COMMUNITY)
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat("MODEL 3: Full Ecological Model (All Levels)\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")
...
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat(" MODEL COMPARISON: Testing Ecological Framework\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")
...
# 3.8 FINAL MODEL: CHECK FOR INTERACTIONS
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat(" Step 3: Testing key interactions...\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")

# Test interaction: partner_alcohol × mental_health_score
...
# Test interaction: education_high × wealth_high
...
# Select final model (use Model 3 unless interactions are significant)
final_model <- model3
...
# 3.9 DIAGNOSTICS FOR FINAL MODEL
cat("═══════════════════════════════════════════════════════════════════════════\n")
...
# 3.10 EXTRACT ODDS RATIOS AND CONFIDENCE INTERVALS
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat("Step 5: Final adjusted odds ratios...\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")
...
# 3.13 INTERPRETATION SUMMARY
cat("═══════════════════════════════════════════════════════════════════════════\n")
cat(" PHASE 3 INTERPRETATION SUMMARY\n")
cat("═══════════════════════════════════════════════════════════════════════════\n\n")

cat("Causal Inference Phase Complete!\n\n")
...
# Load Phase 2 importance if available
if(file.exists("outputs/phase2_variable_importance.csv")) {
  ...
  cat("Interpretation:\n")
  cat(" Random Forest identifies strongest predictors (best for prediction)\n")
  cat("Logistic regression controls for confounding (best for causation)\n")
  cat("Both methods complement each other in understanding GBV risk\n\n")
}