# Installing packages if not well installed already
...
# simulating realistic GBV dataset and quality check
...
#  proceeding if simulation was successful
...
# table2: prevalance by demographics
...
# correlation matrix for cont' predictors
...
# creating consistent prevalence tables for saving
...
# creating bivariate results table 

# checking what columns exist in the correlation data first
