...
# Creating integrated summary of key findings:

# Extracting top predictors from each phase
...
# Using all_pathways instead of pathway_results
...
# creating comprehensive r.factors comparison:
...
c
# Printing the complete table first to see what columns exist
print(comparison_table)
cat("\n\n")

# followed by a nicely formatted version with available columns
